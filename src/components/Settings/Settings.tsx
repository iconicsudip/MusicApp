...
export default function Settings({setTransColor,allColor,setAllColor}:any) {
    const getsetColor = (e:any)=>{
        ...
        let hexcolor = ("#"+r.toString(16)+g.toString(16)+b.toString(16)+"c2");
        setAllColor(e.currentTarget.style.color)
        setTransColor(hexcolor)
    }
    return (
        <div className='app-settings' style={{"background":allColor}}>
            <h2>App Settings</h2>
            <div className="user-settings">
                <div className="color-palette">
                    <BsPaletteFill />
                    <div className="colors">
                        <BsCircleFill id='color1' name='#dd35ff' style={{"color":"#dd35ff"}} onClick={getsetColor}/>
